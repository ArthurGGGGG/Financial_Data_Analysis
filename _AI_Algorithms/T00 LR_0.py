...
## MICROSOFT EXCEL INTEGRATED FORMULA FOR LINEAR BEST-FIT TRENDLINE
# CHECK :: https://support.microsoft.com/en-us/office/linest-function-84d7d0d9-6e50-4101-977a-fa7abf772b6d#:~:text=The%20equation%20of%20a%20straight,also%20use%20the%20TREND%20function.
...
# TEST EQUATIONS FOR [COMBINED] && [SINGLE] (max/min/avg) ON EXCEL (BEST-FIT LINEAR LINE)
# COMBINE ALL DATAFRAMES INTO ONE AND EXPORT AS XLSX

df.rename(columns = {'Adj Close':'df_combined'}, inplace = True)
df.insert(loc=2, column='df_max_00', value='NaN', allow_duplicates=True)
df.insert(loc=3, column='df_min_00', value='NaN', allow_duplicates=True)
df.insert(loc=4, column='df_avg_00', value='NaN', allow_duplicates=True)

df['df_max_00'] = df_max_00['Adj Close']
df['df_min_00'] = df_min_00['Adj Close']
df['df_avg_00'] = df_avg_00['Adj Close']
df.to_excel("aima-data/LR_XLSX.xlsx", index = False)

# THIS ALLOWS US TO LOOK AT THE LINEAR BEHAVIOUR OF DATA, DIRECTLY ON EXCEL
...
# df_combined :: y = 106.77x + 297.35 && R² = 0.8719
# df_max_00 :: y = 71.785x + 530.58 && R² = 0.7527
# df_min_00 :: y = 71.002x + 535.79 && R² = 0.7597
# df_avg_00 :: y = 71.401x + 533.14 && R² = 0.7562

# OTHER QUANTITATIVE BEHAVIORAL ANALYSIS REQUIRED:
# * EXPONENTIAL
# * LINEAR
# * LOGARITHMIC
# * POWER
